...
const filter =
  "brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(0%) contrast(100%)";
            ...
            >
              <img
                ...
                style={{
                  color: "white",
                  fontSize: "30px",
                  filter: activeTab === "background" ? filter1 : filter,
                }}
              />
            </button>
            ...
            >
              <img
                ...
                style={{
                  color: "white",
                  fontSize: "30px",
                  filter: activeTab === "title" ? filter1 : filter,
                }}
              />
            </button>
            ...
            >
              <img
                ...
                style={{
                  color: "white",
                  fontSize: "30px",
                  filter: activeTab === "bubble" ? filter1 : filter,
                }}
              />
            </button>
            ...
            >
              <img
                ...
                style={{
                  color: "white",
                  fontSize: "30px",
                  filter: activeTab === "element" ? filter1 : filter,
                }}
              />
            </button>
            ...
            >
              <img
                ...
                style={{
                  color: "white",
                  fontSize: "30px",
                  filter: activeTab === "writePost" ? filter1 : filter,
                }}
              />
            </button>
          </div>
          ...
          <div style={{ width: "300px", height: "480px", padding: "10px" }}>
            {activeTab == "background" && (
              <div>
                ...
                <ImageViewer
                  clickHandler={(img: undefined) => updateBackgroundImage(img)}
