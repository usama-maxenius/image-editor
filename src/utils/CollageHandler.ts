...
export const createVerticalCollage = (
	...
	rect.on('moving', () => {
		...
		clipPath2
			.set({ height: height - rectHeight!, top: rectHeight })
			.setCoords();
...
export const createHorizontalCollage = (
	canvas: fabric.Canvas,
	images: string[]
) => {
	const width = canvas.getWidth();
...
export const updateVerticalCollageImage = (
...
export const updateHorizontalCollageImage = (
	canvas: fabric.Canvas | null,
	newImage: string,
	activeObject: fabric.Object
) => {
