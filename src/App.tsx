...
function App() {
  ...
  useEffect(() => {
    setUpdatedSeedData({
      ...seedData,
      backgroundImages: scrappedData.image_urls.length > 0 ? scrappedData.image_urls : seedData.backgroundImages,
      bubbles: scrappedData.image_urls.length > 0 ? scrappedData.image_urls : seedData.bubbles,
      texts: scrappedData.generated_titles.length > 0 ? scrappedData.generated_titles : seedData.texts
    })
  }, [scrappedData])
