...
var ComponentBase = {
  ...
  extend: function extend() {
    ...
    var getPTValue = function getPTValue2() {
      ...
      return mergeSections || !mergeSections && self ? useMergeProps ? mergeProps2(globalPT, self, Object.keys(datasetProps).length ? datasetProps : {}) : _objectSpread2(_objectSpread2(_objectSpread2({}, globalPT), self), Object.keys(datasetProps).length ? datasetProps : {}) : _objectSpread2(_objectSpread2({}, self), Object.keys(datasetProps).length ? datasetProps : {});
    };
...
var _usePT = function _usePT2(pt, callback, key, params) {
  ...
  if (pt !== null && pt !== void 0 && pt.hasOwnProperty("_usept")) {
    ...
    return mergeSections || !mergeSections && value ? useMergeProps ? mergeProps2(originalValue, value) : _objectSpread2(_objectSpread2({}, originalValue), value) : value;
  }
  return fn(pt);
};
...
var ColorPicker = React7.memo(React7.forwardRef(function(inProps, ref) {
  ...
  var createInput = function createInput2() {
    if (!props.inline) {
      ...
      var _inputProps = mergeProps(_objectSpread5({
        ref: inputRef,
        type: "text",
        readOnly: true,
        className: cx("input"),
