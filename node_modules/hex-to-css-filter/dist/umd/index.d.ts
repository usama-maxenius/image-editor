...
interface HexToCssConfiguration {
    /**
 ...
 *
 */
declare const hexToCSSFilter: (colorValue: string, opts?: HexToCssConfiguration) => HexToCssResult;
/**
 ...
 * @returns void
 */
declare const clearCache: (key?: string | undefined) => void;

export { HexToCssConfiguration, HexToCssResult, clearCache, hexToCSSFilter };
